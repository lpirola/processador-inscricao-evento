...
describe('Action is empty', () => {
		...
		it('And Filters are not empty and validated')
		it('And  Actions is not fulfilled')
		it('When Developer try to process all subscriptions')
		it('Then Process should stop')
		it('And output a message with warning about missing action')
})
